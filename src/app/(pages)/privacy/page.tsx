  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div className="bg-gradient-to-br from-primary-600 via-primary-500 to-primary-400 text-white">
        <div className="container mx-auto px-4 py-12 sm:py-16">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
            <div className="w-20 h-20 rounded-3xl bg-white/20 backdrop-blur-sm flex items-center justify-center shadow-2xl shadow-primary-900/30 ring-1 ring-white/30">
              <svg
                data-prefix="fas"
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="bg-gradient-to-r from-primary-50 to-primary-100/50 border border-primary-200 rounded-3xl p-6 sm:p-8 mb-12 shadow-sm">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 rounded-2xl bg-primary-500 flex items-center justify-center flex-shrink-0 shadow-lg shadow-primary-500/25">
              <svg
                data-prefix="fas"
                data-icon="shield-halved"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
          <section className="bg-white rounded-3xl border border-gray-100 p-6 sm:p-8 shadow-sm hover:shadow-lg hover:border-primary-100 transition-all duration-300 group">
            <div className="flex items-start gap-4 mb-5">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-primary-100 to-primary-50 flex items-center justify-center flex-shrink-0 group-hover:from-primary-500 group-hover:to-primary-400 transition-all duration-300">
                <svg
                  data-prefix="fas"
                  data-icon="database"
                  className="svg-inline--fa fa-database text-xl text-primary-600 group-hover:text-white transition-colors duration-300"
                  role="img"
                  viewBox="0 0 448 512"
                  aria-hidden="true"
                >
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3 text-gray-600 leading-relaxed">
                <span className="text-xs font-bold text-primary-500 bg-primary-50 px-2 py-0.5 rounded-md mt-0.5 flex-shrink-0">
                  1.1
                </span>
                <p className="text-sm">
            ...
            <div className="flex items-start gap-4 mb-5">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-primary-100 to-primary-50 flex items-center justify-center flex-shrink-0 group-hover:from-primary-500 group-hover:to-primary-400 transition-all duration-300">
                <svg
                  ...
                  className="svg-inline--fa fa-user-shield text-xl text-primary-600 group-hover:text-white transition-colors duration-300"
                  role="img"
                  viewBox="0 0 576 512"
                  aria-hidden="true"
                >
            ...
            <div className="flex items-start gap-4 mb-5">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-primary-100 to-primary-50 flex items-center justify-center flex-shrink-0 group-hover:from-primary-500 group-hover:to-primary-400 transition-all duration-300">
                <svg
                  data-prefix="fas"
                  data-icon="lock"
                  className="svg-inline--fa fa-lock text-xl text-primary-600 group-hover:text-white transition-colors duration-300"
                  role="img"
                  viewBox="0 0 384 512"
                  aria-hidden="true"
                >
            ...
            <div className="flex items-start gap-4 mb-5">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-primary-100 to-primary-50 flex items-center justify-center flex-shrink-0 group-hover:from-primary-500 group-hover:to-primary-400 transition-all duration-300">
                <svg
                  ...
                  className="svg-inline--fa fa-share-nodes text-xl text-primary-600 group-hover:text-white transition-colors duration-300"
                  role="img"
                  viewBox="0 0 512 512"
                  aria-hidden="true"
                >
            ...
            <div className="flex items-start gap-4 mb-5">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-primary-100 to-primary-50 flex items-center justify-center flex-shrink-0 group-hover:from-primary-500 group-hover:to-primary-400 transition-all duration-300">
                <svg
                  ...
                  className="svg-inline--fa fa-user-check text-xl text-primary-600 group-hover:text-white transition-colors duration-300"
                  role="img"
                  viewBox="0 0 640 512"
                  aria-hidden="true"
                >
            ...
            <div className="flex items-start gap-4 mb-5">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-primary-100 to-primary-50 flex items-center justify-center flex-shrink-0 group-hover:from-primary-500 group-hover:to-primary-400 transition-all duration-300">
                <svg
                  data-prefix="fas"
                  data-icon="cookie"
                  className="svg-inline--fa fa-cookie text-xl text-primary-600 group-hover:text-white transition-colors duration-300"
                  role="img"
                  viewBox="0 0 512 512"
                  aria-hidden="true"
                >
            ...
            <div className="flex items-start gap-4 mb-5">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-primary-100 to-primary-50 flex items-center justify-center flex-shrink-0 group-hover:from-primary-500 group-hover:to-primary-400 transition-all duration-300">
                <svg
                  data-prefix="fas"
                  data-icon="clock"
                  className="svg-inline--fa fa-clock text-xl text-primary-600 group-hover:text-white transition-colors duration-300"
                  role="img"
                  viewBox="0 0 512 512"
                  aria-hidden="true"
                >
            ...
            <div className="flex items-start gap-4 mb-5">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-primary-100 to-primary-50 flex items-center justify-center flex-shrink-0 group-hover:from-primary-500 group-hover:to-primary-400 transition-all duration-300">
                <svg
                  data-prefix="fas"
                  data-icon="envelope"
                  className="svg-inline--fa fa-envelope text-xl text-primary-600 group-hover:text-white transition-colors duration-300"
                  role="img"
                  viewBox="0 0 512 512"
                  aria-hidden="true"
                >
