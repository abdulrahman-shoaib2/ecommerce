            ...
            <div className="flex items-start gap-4 mb-5">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-primary-100 to-primary-50 flex items-center justify-center flex-shrink-0 group-hover:from-primary-500 group-hover:to-primary-400 transition-all duration-300">
                <svg
                  data-prefix="fas"
                  data-icon="handshake"
                  className="svg-inline--fa fa-handshake text-xl text-primary-600 group-hover:text-white transition-colors duration-300"
                  role="img"
                  viewBox="0 0 576 512"
                  aria-hidden="true"
                >
            ...
            <div className="flex items-start gap-4 mb-5">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-primary-100 to-primary-50 flex items-center justify-center flex-shrink-0 group-hover:from-primary-500 group-hover:to-primary-400 transition-all duration-300">
                <svg
                  data-prefix="fas"
                  data-icon="id-card"
                  className="svg-inline--fa fa-id-card text-xl text-primary-600 group-hover:text-white transition-colors duration-300"
                  role="img"
                  viewBox="0 0 576 512"
                  aria-hidden="true"
                >
            ...
            <div className="flex items-start gap-4 mb-5">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-primary-100 to-primary-50 flex items-center justify-center flex-shrink-0 group-hover:from-primary-500 group-hover:to-primary-400 transition-all duration-300">
                <svg
                  ...
                  className="svg-inline--fa fa-credit-card text-xl text-primary-600 group-hover:text-white transition-colors duration-300"
                  role="img"
                  viewBox="0 0 512 512"
                  aria-hidden="true"
                >
            ...
            <div className="flex items-start gap-4 mb-5">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-primary-100 to-primary-50 flex items-center justify-center flex-shrink-0 group-hover:from-primary-500 group-hover:to-primary-400 transition-all duration-300">
                <svg
                  data-prefix="fas"
                  data-icon="truck"
                  className="svg-inline--fa fa-truck text-xl text-primary-600 group-hover:text-white transition-colors duration-300"
                  role="img"
                  viewBox="0 0 576 512"
                  aria-hidden="true"
                >
            ...
            <div className="flex items-start gap-4 mb-5">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-primary-100 to-primary-50 flex items-center justify-center flex-shrink-0 group-hover:from-primary-500 group-hover:to-primary-400 transition-all duration-300">
                <svg
                  ...
                  className="svg-inline--fa fa-rotate-left text-xl text-primary-600 group-hover:text-white transition-colors duration-300"
                  role="img"
                  viewBox="0 0 512 512"
                  aria-hidden="true"
                >
            ...
            <div className="flex items-start gap-4 mb-5">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-primary-100 to-primary-50 flex items-center justify-center flex-shrink-0 group-hover:from-primary-500 group-hover:to-primary-400 transition-all duration-300">
                <svg
                  ...
                  className="svg-inline--fa fa-scale-balanced text-xl text-primary-600 group-hover:text-white transition-colors duration-300"
                  role="img"
                  viewBox="0 0 640 512"
                  aria-hidden="true"
                >
