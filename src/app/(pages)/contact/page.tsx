              ...
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-primary-50 flex items-center justify-center shrink-0">
                  <svg
                    data-prefix="fas"
                    data-icon="phone"
                    className="svg-inline--fa fa-phone text-primary-600 text-lg"
                    role="img"
                    viewBox="0 0 512 512"
                    aria-hidden="true"
                  >
              ...
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-primary-50 flex items-center justify-center shrink-0">
                  <svg
                    data-prefix="fas"
                    data-icon="envelope"
                    className="svg-inline--fa fa-envelope text-primary-600 text-lg"
                    role="img"
                    viewBox="0 0 512 512"
                    aria-hidden="true"
                  >
              ...
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-primary-50 flex items-center justify-center shrink-0">
                  <svg
                    ...
                    className="svg-inline--fa fa-location-dot text-primary-600 text-lg"
                    role="img"
                    viewBox="0 0 384 512"
                    aria-hidden="true"
                  >
              ...
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-primary-50 flex items-center justify-center shrink-0">
                  <svg
                    data-prefix="fas"
                    data-icon="clock"
                    className="svg-inline--fa fa-clock text-primary-600 text-lg"
                    role="img"
                    viewBox="0 0 512 512"
                    aria-hidden="true"
                  >
              ...
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 rounded-xl bg-primary-50 flex items-center justify-center">
                  <svg
                    data-prefix="fas"
                    data-icon="headset"
                    className="svg-inline--fa fa-headset text-primary-600 text-lg"
                    role="img"
                    viewBox="0 0 448 512"
                    aria-hidden="true"
                  >
              ...
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-white flex items-center justify-center shrink-0 shadow-sm">
                  <svg
                    ...
                    className="svg-inline--fa fa-circle-question text-primary-600 text-xl"
                    role="img"
                    viewBox="0 0 512 512"
                    aria-hidden="true"
                  >
