...
import CartCard from "@/app/(pages)/cart/_components/CartCard";
import {
  faShoppingCart,
  faArrowRight,
  faBoxOpen,
                        ...
                        <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl p-4">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-sm font-medium text-gray-700">
                              Add {500 - cart?.data.totalCartPrice} EGP for free shipping
                            </span>
                          </div>
                          <div className="h-2 bg-orange-100 rounded-full overflow-hidden">
                            <div
                              className="h-full bg-gradient-to-r from-orange-400 to-amber-400 rounded-full transition-all duration-500"
                              style={{ width: `${cart?.data.totalCartPrice / 500 * 100}%` }}
                            />
                          </div>
                        </div>
                    }
                        ...
                        <div className="flex justify-between items-baseline">
                          ...
                          <div className="text-right">
                            <span className="text-2xl font-bold text-gray-900">
                              {cart?.data.totalCartPrice.toLocaleString()}
                            </span>
              ...
              <div className="lg:col-span-1">
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden sticky top-4">
                  ...
                  <div className="p-5 space-y-4">
                    <div className="flex justify-between text-gray-600">
                      <span>Subtotal ({cart?.data.products.length} items)</span>
