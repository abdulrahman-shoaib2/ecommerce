    ...
    <section className="py-16 bg-linear-to-b from-white to-gray-50">
      <div className="container mx-auto">
        <div className="relative">
          <div ref={ref} className={`bg-linear-to-br from-emerald-50 via-white to-teal-50 rounded-[2.5rem] border border-emerald-100/50 shadow-2xl shadow-emerald-500/10  transition-all duration-500 delay-300 ${visible?'translate-y-0 opacity-100':'opacity-0 translate-y-1/4'}`}>
