  ...
  return (
    <div className="jsx-f1a4a174e49dbaab min-h-screen bg-[#fafbfc] flex items-center justify-center px-4 py-16 relative overflow-hidden">
      <div className="jsx-f1a4a174e49dbaab absolute inset-0 overflow-hidden">
        ...
        <div className="jsx-f1a4a174e49dbaab absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-bl from-primary-100/40 to-transparent rounded-full blur-3xl" />
        <div className="jsx-f1a4a174e49dbaab absolute bottom-0 left-0 w-[400px] h-[400px] bg-gradient-to-tr from-primary-100/30 to-transparent rounded-full blur-3xl" />
      </div>
      <div className="jsx-f1a4a174e49dbaab relative z-10 max-w-xl w-full">
          ...
          <div className="jsx-f1a4a174e49dbaab relative">
            ...
            <div className="jsx-f1a4a174e49dbaab relative w-64 h-52 sm:w-72 sm:h-60">
              <div className="jsx-f1a4a174e49dbaab absolute inset-x-0 top-4 mx-auto w-52 h-40 sm:w-60 sm:h-44 bg-white rounded-3xl shadow-xl shadow-gray-200/60 border border-gray-100 flex items-center justify-center overflow-hidden">
                <div className="jsx-f1a4a174e49dbaab absolute inset-0 bg-gradient-to-br from-primary-50/80 via-transparent to-primary-100/40" />
                <svg
                  data-prefix="fas"
              ...
              <div className="jsx-f1a4a174e49dbaab absolute -top-2 -right-2 sm:top-0 sm:right-0">
                <div className="jsx-f1a4a174e49dbaab relative">
                  ...
                  <div className="jsx-f1a4a174e49dbaab relative w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-br from-primary-500 to-primary-600 flex items-center justify-center shadow-lg shadow-primary-500/40">
                    <span className="jsx-f1a4a174e49dbaab text-xl sm:text-2xl font-black text-white tracking-tight">
                      404
                    </span>
                  </div>
                </div>
        ...
        <div className="jsx-f1a4a174e49dbaab text-center mb-10">
          <h1 className="jsx-f1a4a174e49dbaab text-4xl sm:text-5xl font-black text-gray-900 mb-4 tracking-tight">
            Oops! Nothing Here
          </h1>
          <p className="jsx-f1a4a174e49dbaab text-gray-500 text-lg leading-relaxed max-w-md mx-auto">
            Looks like this page went out of stock! Don't worry, there's plenty
            more fresh content to explore.
          </p>
        </div>
        <div className="jsx-f1a4a174e49dbaab flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          <a
          ...
          <button className="jsx-f1a4a174e49dbaab group w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-700 py-4 px-8 rounded-2xl font-bold text-lg transition-all duration-300 shadow-md hover:shadow-lg border border-gray-200 hover:-translate-y-1">
            <svg
              data-prefix="fas"
