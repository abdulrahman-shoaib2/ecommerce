        ...
        <div className="flex justify-between items-center h-10">
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-4 text-gray-500">
              ...
              >
                <FontAwesomeIcon
                  icon={contactInfo[0].icon.faName}
              ...
              {session.data?.user?.name ? (
                <>
                  ...
                  <Button className="flex items-center gap-1.5 bg-transparent text-gray-600 hover:text-red-500 transition-colors" onClick={()=>signOut({callbackUrl:'/login'})}>
                    <FontAwesomeIcon icon={faRightFromBracket} className="svg-inline--fa fa-right-from-bracket text-xs" />
                    <span>Sign Out</span>
                  </Button>
                </>
              ) : (
                <>
                  ...
                  >
                    <FontAwesomeIcon
                      icon={faUserPlus}
                      className="svg-inline--fa fa-user-plus  text-xs"
                    />
