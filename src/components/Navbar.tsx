            ...
            <div className="flex items-center gap-1 lg:gap-2">
              ...
              <div className="flex justify-around items-center">
                ...
                >
                  ...
                  />
                  <span className="absolute w-4 h-4 top-0.5 right-0.5 size-4.5 rounded-full bg-primary-600 text-white text-[10px] leading-tight font-bold flex items-center justify-center ring-2 ring-white ">
                    { isLoading ?
